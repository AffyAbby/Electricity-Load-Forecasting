function data2=LoadDataFilter2(y)
%y = readmatrix('UnfilteredLoadData.xlsx','Sheet','Sheet3');
%y = readmatrix('WeekLoadData.xlsm','Sheet','To be filtered','Range','A1:C2005');
if(nargin==0)
 y = readmatrix('WeekLoadData.xlsm','Sheet','Oct Data');
end
...
save OctFilteredLoad.mat data2