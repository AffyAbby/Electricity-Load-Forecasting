...
#include "loadForecasting_idl_i.c"
...
{
  {
    ...
    Class1::GetClassObject, "Class1", "loadForecasting.Class1", 
    "loadForecasting.Class1.1_0"
  },
  {
...
{
  return g_pModule->InitMain(objectmap, &LIBID_loadForecasting, 1, 0, hInstance, 
                             dwReason, pv);
}
