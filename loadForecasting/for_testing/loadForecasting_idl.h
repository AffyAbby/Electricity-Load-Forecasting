...
#ifndef __loadForecasting_idl_h__
#define __loadForecasting_idl_h__
...
EXTERN_C const IID IID_IClass1;
    ...
    MIDL_INTERFACE("BCBABCF6-D77B-4E30-BC20-DD72ADCBB080")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE loadForecasting( 
            /* [in] */ long nargout,
            /* [out][in] */ VARIANT *y,
            /* [in] */ VARIANT date,
    ...
    typedef struct IClass1Vtbl
    {
        ...
        DECLSPEC_XFGVIRT(IClass1, loadForecasting)
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *loadForecasting )( 
            IClass1 * This,
            /* [in] */ long nargout,
            /* [out][in] */ VARIANT *y,
            /* [in] */ VARIANT date,
...
#define IClass1_loadForecasting(This,nargout,y,date,temperature,isHoliday)	\
    ( (This)->lpVtbl -> loadForecasting(This,nargout,y,date,temperature,isHoliday) ) 
...
#ifndef __loadForecasting_LIBRARY_DEFINED__
#define __loadForecasting_LIBRARY_DEFINED__

/* library loadForecasting */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_loadForecasting;

EXTERN_C const CLSID CLSID_Class1;

#ifdef __cplusplus

class DECLSPEC_UUID("604C58F6-E609-4B53-ACFF-F1C4A211013F")
Class1;
#endif
#endif /* __loadForecasting_LIBRARY_DEFINED__ */
