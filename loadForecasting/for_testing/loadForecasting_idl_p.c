...
typedef struct _loadForecasting_idl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } loadForecasting_idl_MIDL_TYPE_FORMAT_STRING;

typedef struct _loadForecasting_idl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } loadForecasting_idl_MIDL_PROC_FORMAT_STRING;

typedef struct _loadForecasting_idl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } loadForecasting_idl_MIDL_EXPR_FORMAT_STRING;
...
extern const loadForecasting_idl_MIDL_TYPE_FORMAT_STRING loadForecasting_idl__MIDL_TypeFormatString;
extern const loadForecasting_idl_MIDL_PROC_FORMAT_STRING loadForecasting_idl__MIDL_ProcFormatString;
extern const loadForecasting_idl_MIDL_EXPR_FORMAT_STRING loadForecasting_idl__MIDL_ExprFormatString;
...
static const loadForecasting_idl_MIDL_PROC_FORMAT_STRING loadForecasting_idl__MIDL_ProcFormatString =
    {
        0,
        {
...
static const loadForecasting_idl_MIDL_TYPE_FORMAT_STRING loadForecasting_idl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IClass1, ver. 0.0,
   GUID={0xBCBABCF6,0xD77B,0x4E30,{0xBC,0x20,0xDD,0x72,0xAD,0xCB,0xB0,0x80}} */
...
static const MIDL_STUBLESS_PROXY_INFO IClass1_ProxyInfo =
    {
    &Object_StubDesc,
    loadForecasting_idl__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(11) _IClass1ProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IClass1::loadForecasting */ ,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    loadForecasting_idl__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _loadForecasting_idl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IClass1ProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _loadForecasting_idl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IClass1StubVtbl,
    0
};

PCInterfaceName const _loadForecasting_idl_InterfaceNamesList[] = 
{
    "IClass1",
    0
};

const IID *  const _loadForecasting_idl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _loadForecasting_idl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _loadForecasting_idl, pIID, n)

int __stdcall _loadForecasting_idl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_loadForecasting_idl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
EXTERN_C const ExtendedProxyFileInfo loadForecasting_idl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _loadForecasting_idl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _loadForecasting_idl_StubVtblList,
    (const PCInterfaceName * ) & _loadForecasting_idl_InterfaceNamesList,
    (const IID ** ) & _loadForecasting_idl_BaseIIDList,
    & _loadForecasting_idl_IID_Lookup, 
    1,
    2,
