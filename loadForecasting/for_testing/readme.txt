loadForecasting MATLAB Excel Add-in 
...
-loadForecasting_1_0.dll (output from mcc)
-loadForecasting.bas (VBA module file created by mcc)
-loadForecasting.xla (Excel AddIn file created by mcc)
-MCRInstaller.exe
...
NOTE: Verify that loadForecasting_1_0.dll is registered on the target machine. If you 
